module Common
  module MonitoringHelper
	...
	def update_threshold(driver, warning, error, settings_link)
		...
		puts driver.find_element(:xpath, "//*[@id='monitoring-summary']/div[1]/h3").text
		...
		puts driver.find_element(:xpath, "//*[@id='monitoring-settings']/div[1]/h4/span").text
   	...
   	puts driver.find_element(:xpath, "//*[@id='monitoring-settings']/div[2]/div/div/p/p").text
	end
